...
export function AnimatedStat({
  ...
  // Cuando forceTwoLines:
  //  - Mobile: cifra en 1 línea + unidad en 2ª línea (ambos centrados).
  //  - Desktop (sm+): cifra y unidad en la MISMA línea (inline).
  //  El truco: la unidad usa `block sm:inline` para colapsar en desktop.
  //  Como todo el span hereda el className del padre, peso/familia/color
  //  quedan idénticos entre cifra y unidad. El tamaño de unidad iguala
  //  al de la cifra (no reducimos) para consistencia visual.
  if (forceTwoLines) {
