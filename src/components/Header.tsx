        ...
        <nav className="hidden items-center gap-1 lg:flex">
          <div className="relative">
            ...
            {open &&
              ...
              createPortal(
                <>
                  {/* Backdrop invisible — sólo captura clicks fuera del panel
                      para cerrarlo. NO oscurece el resto para que el header
                      y el hero conserven su look. */}
                  <div
                    className="fixed inset-0 z-[100]"
                    onClick={() => setOpen(false)}
                    aria-hidden
                  />
                  {/* Panel productos — glass navy oscuro con preview.
                      Estructura: preview grande a la izquierda + lista de
                      productos a la derecha. Al hacer hover en un item de
                      la lista, `hoveredProduct` cambia y el preview refleja
                  ...
                  <div
                    ...
                    style={{
                      // Glass real: navy translúcido muy bajo (30%) para que
                      // el hero detrás se vea desenfocado. El blur agresivo
                      // hace el trabajo de legibilidad.
                  ...
                  >
                    <div className="container-x py-8">
                      <div className="grid gap-8 md:grid-cols-[minmax(0,1fr)_minmax(0,1.2fr)] md:gap-12">
                        {/* Preview grande — muestra el producto activo/hover.
                            Fondo background-4 (#C7E2F7 = --color-sky) del DS,
                            claro y neutro para máximo contraste con el navy
                            de los renders. */}
