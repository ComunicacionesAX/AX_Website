...
export function ProductPage({
  ...
  // Auto-rotate del accordion de "La solución". El array tiene 1
  // highlight (-2) + N features (0..N-1). Usamos índices normalizados
  // [0..N] mapeados a openFeature = [-2, 0, 1, 2, ...].
  ...
  return (
    <div className="bg-gradient-to-b from-sky-50 via-white to-sky-50">
      ...
      <section className="container-x py-16">
        ...
        {/* Grid responsive: 1 columna en mobile (imagen sobre features
            apilados), 2 columnas asimétricas en lg+ (según solutionGridCols).
            El grid-template-columns inline sólo aplica en lg+ para respetar
        ...
        >
          ...
          {/* Accordion con auto-rotate y barra glaciar de progreso.
              Sólo el card abierto recibe `progress` (0..1) — se pinta
              como el fill de la barra cyan que crece con el tiempo.
              Al llenarse, el hook avanza al siguiente card. Hover del
              contenedor pausa la rotación. */}
              ...
              {slides.map((s, i) => (
                ...
                >
                  ...
                  <div className="absolute inset-x-0 bottom-0 p-8 text-white sm:p-14">
                    ...
                    {/* Barra glaciar de progreso — se llena con el
                        tiempo del autoplay (0→100%) del slide activo.
                        Slides no activos muestran el track vacío.
                        Al llenarse, el hook cambia al slide siguiente. */}
                    <div
                      aria-hidden="true"
