    ...
    <div className="bg-white">
      ...
      <section className="container-x py-16">
        <div className="grid gap-6 lg:grid-cols-[1.9fr_1fr]">
          {/* Feature card — imagen full-bleed con gradient hacia abajo,
              título display grande estilo hero. Hover: escalado + más
              elevación. */}
          <a
        ...
        {/* NCSU study card — glass card con hover mejorado.
            Layout: render a la izquierda + copy a la derecha. Título
            escala DS subhead, logo NCSU + texto en columna vertical
            para respirar en desktop. */}
        <a
          href={NCSU_STUDY_URL}
          target="_blank"
          rel="noopener noreferrer"
      ...
      {/* Cross-nav sobre canvas blanco. El gradient de transición
          hacia el footer que teníamos aquí (blanco → sky → teal → navy)
          y el prop `flushTop` en el Footer están documentados en
          `docs/page-transition-gradients.md` para reactivarlos cuando
          se requiera ese cierre visual. */}
