...
export function CookieBanner() {
  ...
  return (
    <>
      {/* Banner principal — fijo al bottom, borde superior cyan.
          NOTA: sin la clase `on-dark`. Aquí el CTA primario debe ser teal
          sólido con texto blanco (matchea referencia Iluma), NO glacier
          (cyan sólido texto navy) que es el override on-dark. Los botones
          usan clases explícitas en vez de btn-primary/btn-secondary del DS. */}
      <div
        role="dialog"
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Footer con acciones — border-t sky, patrón dialog DS.
            CTAs consistentes con el resto del sitio: outline neutral
            (rechazar) con hover teal + teal sólido (save) que se
            oscurece con lift al hover. */}
