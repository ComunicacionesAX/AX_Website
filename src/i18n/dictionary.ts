...
const es = {
  ...
  hero: {
    title1: "Monitoreo",
    title2: "inteligente",
    subtitle: "para granjas porcinas y avícolas",
    cta: "Evaluar mi granja",
    pill: "Cámaras inteligentes, sensores y herramientas de IA que transforman datos en rentabilidad.",
  },
  problems: {
  ...
  audience: {
    ...
    title2: "es Asimetrix?",
    segments: [
      { title: "Productores", text: "que buscan más control y rentabilidad" },
      { title: "Equipos técnicos", text: "que necesitan datos confiables" },
  ...
  midCta: {
    ...
    cta: "Hablemos sobre tu operación",
  },
  ecosystem: {
    title1: "Somos parte de un",
    title2: "ecosistema global",
    title3: "de innovación",
    copy: "Impulsados por el propósito de diseñar nutrición para mejorar vidas. Integramos ciencia, tecnología y conocimiento para enfrentar los desafíos reales de la producción animal.",
  ...
  footer: {
    ...
    login: "Login",
    legal: "Designing nutrition, enhancing lives. 1307 Person St, Durham, North Carolina. +57 6041500. © 2026 Iluma Alliance",
  ...
  pigvision: {
    subtitle: "Cámara inteligente para pesar cerdos en ceba",
  ...
  nodos: {
    title1: "Nodos",
    title2: "ambientales",
    subtitle: "Monitoreo continuo de variables clave: temperatura, humedad, CO₂ y luz para mantener estabilidad y anticipar riesgos.",
    tagline: "Condiciones visibles, intervención oportuna.",
  ...
  saber: {
    title: "El poder del saber",
    subtitle: "Información técnica, análisis y datos que explican cómo el monitoreo continuo mejora la rentabilidad en granja.",
    ...
    ncsuTitle: "Estudio realizado por NCSU sobre el funcionamiento de PigVision",
  ...
  cotizar: {
    heroTitle1: "Cuéntanos",
    heroTitle2: "sobre tu",
    heroTitle3: "operación",
    heroSubtitle: "Te ayudaremos a buscar las mejores soluciones.",
    introTitle: "Completa la información y te contactaremos",
    ...
    submitting: "Enviando...",
    successMsg: "¡Gracias! Recibimos tu información y te contactaremos pronto.",
...
const en: typeof es = {
  nav: {
    ...
    productItems: [
      { name: "PigVision", desc: "Camera to weigh finishing pigs", href: "/pigvision" },
      { name: "Insylo", desc: "Feed and consumption control", href: "/insylo" },
      { name: "Environmental Sensors", desc: "Environment under control", href: "/nodos" },
    ],
  },
  hero: {
    title1: "Intelligent",
    title2: "monitoring",
    subtitle: "for swine and poultry farms",
    cta: "Assess my farm",
    pill: "Smart cameras, sensors and AI tools that turn data into profitability.",
  },
  problems: {
  ...
  audience: {
    ...
    segments: [
      { title: "Producers", text: "seeking more control and profitability" },
      { title: "Technical teams", text: "who need reliable data" },
  ...
  ecosystem: {
    ...
    copy: "Driven by the purpose of designing nutrition to improve lives. We integrate science, technology and knowledge to face the real challenges of animal production.",
  ...
  nodos: {
    ...
    title2: "nodes",
    subtitle: "Continuous monitoring of key variables: temperature, humidity, CO₂ and light to maintain stability and anticipate risks.",
    tagline: "Visible conditions, timely intervention.",
  ...
  saber: {
    title: "The power of knowing",
    subtitle: "Technical information, analysis and data that explain how continuous monitoring improves farm profitability.",
    ...
    ncsuTitle: "Study conducted by NCSU on how PigVision works",
    ncsuRenderAlt: "PigVision",
    ncsuLogoAlt: "NC State University",
  ...
  cotizar: {
    heroTitle1: "Tell us",
    heroTitle2: "about your",
    heroTitle3: "operation",
    heroSubtitle: "We'll help you find the best solutions.",
    introTitle: "Fill in the information and we'll contact you",
    ...
    submitting: "Sending...",
    successMsg: "Thank you! We received your information and will contact you soon.",
